...
A feature-rich WYSIWYG editor for React with a configurable toolbar, menu bar, markdown support, theming, file uploads, and a plugin system.
...
// Defaults
import { DEFAULT_FONTS, DEFAULT_FONT_SIZES, DEFAULT_COLORS, DEFAULT_KEYBINDINGS } from 'remyx-editor';
